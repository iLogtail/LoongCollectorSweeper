...
已合并 run 27287863405 的 热点 产物；reconcile 已与 GitHub 开放/关闭状态对齐，仪表盘已更新。
运行链接：[https://github.com/iLogtail/LoongCollectorSweeper/actions/runs/27287863405](https://github.com/iLogtail/LoongCollectorSweeper/actions/runs/27287863405)
...
最近审查：2026年6月10日 UTC 15:45。最近关闭：2026年6月2日 UTC 17:04。最近评论同步：2026年6月10日 UTC 14:31。

| 时间窗口 | 审查 | 关闭决策 | 保持开启 | 失败/陈旧 | 已关闭 | 评论已同步 | Apply 跳过 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 最近 15 分钟 | 3 | 0 | 3 | 0 | 0 | 0 | 0 |
| 最近 1 小时 | 3 | 0 | 3 | 0 | 0 | 0 | 0 |
| 最近 24 小时 | 64 | 0 | 64 | 0 | 0 | 61 | 0 |
...
| 条目 | 标题 | 结果 | 状态 | 审查时间 |
| --- | --- | --- | --- | --- |
| [#2581](https://github.com/alibaba/loongcollector/issues/2581) | [CRITICAL][BUG] flusher_kafka_v2 can hang due to Sarama broker throttle timer race | [keep_open / kept_open](https://github.com/iLogtail/LoongCollectorSweeper/blob/main/items/2581.md) | complete | 2026年6月10日 UTC 15:45 |
| [#2580](https://github.com/alibaba/loongcollector/pull/2580) | fix(input_etw): harden ETW session cleanup and naming | [keep_open / kept_open](https://github.com/iLogtail/LoongCollectorSweeper/blob/main/items/2580.md) | complete | 2026年6月10日 UTC 15:45 |
| [#2578](https://github.com/alibaba/loongcollector/issues/2578) | [QUESTION]: 已能接收 trace，但flusher_otlp无法转发到 OTLP gRPC 后端 | [keep_open / kept_open](https://github.com/iLogtail/LoongCollectorSweeper/blob/main/items/2578.md) | complete | 2026年6月10日 UTC 15:44 |
