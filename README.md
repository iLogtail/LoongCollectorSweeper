...
更新时间：2026年6月7日 UTC 17:45

状态：热点发布完成

已合并 run 27100013391 的 热点 产物；reconcile 已与 GitHub 开放/关闭状态对齐，仪表盘已更新。
运行链接：[https://github.com/iLogtail/LoongCollectorSweeper/actions/runs/27100013391](https://github.com/iLogtail/LoongCollectorSweeper/actions/runs/27100013391)
...
最近审查：2026年6月7日 UTC 17:45。最近关闭：2026年6月2日 UTC 17:04。最近评论同步：2026年6月7日 UTC 16:47。

| 时间窗口 | 审查 | 关闭决策 | 保持开启 | 失败/陈旧 | 已关闭 | 评论已同步 | Apply 跳过 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 最近 15 分钟 | 3 | 0 | 3 | 0 | 0 | 0 | 0 |
| 最近 1 小时 | 4 | 0 | 4 | 0 | 0 | 15 | 0 |
...
| 条目 | 标题 | 结果 | 状态 | 审查时间 |
| --- | --- | --- | --- | --- |
| [#2580](https://github.com/alibaba/loongcollector/pull/2580) | fix(input_etw): harden ETW session cleanup and naming | [keep_open / kept_open](https://github.com/iLogtail/LoongCollectorSweeper/blob/main/items/2580.md) | complete | 2026年6月7日 UTC 17:45 |
| [#2581](https://github.com/alibaba/loongcollector/issues/2581) | [CRITICAL][BUG] flusher_kafka_v2 can hang due to Sarama broker throttle timer race | [keep_open / kept_open](https://github.com/iLogtail/LoongCollectorSweeper/blob/main/items/2581.md) | complete | 2026年6月7日 UTC 17:45 |
| [#2578](https://github.com/alibaba/loongcollector/issues/2578) | [QUESTION]: 已能接收 trace，但flusher_otlp无法转发到 OTLP gRPC 后端 | [keep_open / kept_open](https://github.com/iLogtail/LoongCollectorSweeper/blob/main/items/2578.md) | complete | 2026年6月7日 UTC 17:44 |
...
| [#2054](https://github.com/alibaba/loongcollector/pull/2054) | feat: enhance encoder interface | [keep_open / kept_open](https://github.com/iLogtail/LoongCollectorSweeper/blob/main/items/2054.md) | complete | 2026年6月7日 UTC 16:45 |
